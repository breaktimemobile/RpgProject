...
public class Content_Upgrade_Panel : MonoBehaviour
{
    ...
    {
        data = BackEndDataManager.instance.upgrade_item_csv_data[lv];
        ...
        img_Content_Upgrade_Reward_0.sprite = Utill.Get_Item_Sp((Item_Type)(int)data["reward_0"]);
        BigInteger big = Calculate.Reward((int)BackEndDataManager.instance.upgrade_item_csv_data[0]["reward_val_0"], 120, lv);
        txt_Content_Upgrade_Reward_0.text = UiManager.instance.GetGoldString(big);
        img_Content_Upgrade_Reward_1.sprite = Utill.Get_Item_Sp((Item_Type)data["reward_1"]);
        big = Calculate.Reward((int)BackEndDataManager.instance.upgrade_item_csv_data[0]["reward_val_1"], 240, lv);
        txt_Content_Upgrade_Reward_1.text = UiManager.instance.GetGoldString(big);
    ...
    public void UnLock()
    {
        ...
        btn_Content_Upgrade_In.interactable = Lv <= BackEndDataManager.instance.Stage_Data.int_stage;
