...
public class Content_Panel : MonoBehaviour
{
    ...
    public void Set_Content_Item(Dictionary<string, object> data)
    {
        ...
        img_Reward_0.sprite = Resources.Load<Sprite>("Item/icon_" + ((Item_Type)(int)data["reward_0"]).ToString());
        img_Reward_1.sprite = Resources.Load<Sprite>("Item/icon_" + ((Item_Type)(int)data["reward_1"]).ToString());
